package com.android.joao.calculodemedia;
...
public class MainActivity extends AppCompatActivity {
    ...
    private void calculaMedia() {
        ...
        String nomes = nomeAluno.getText().toString();
    ...
    private void initComponentes() {
        ...
        nota1 = findViewById(R.id.nome1);
        nota2 = findViewById(R.id.nome2);
        nota3 = findViewById(R.id.nome3);
        nota4 = findViewById(R.id.nome4);
